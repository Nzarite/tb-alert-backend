...
public interface StateHeadRepo extends JpaRepository<StateHead, Long> {
    ...
    List<StateHead> findAllByPerson_Address_GramPanchayat_Mandal_District_State_StateName(String state);

    List<StateHead> findAllByPerson_IsDeletedTrue();

    List<StateHead> findAllByPerson_IsDeletedTrueAndPerson_Address_GramPanchayat_Mandal_District_State_StateName(String personAddressStateStateName);

    List<StateHead> findAllByPerson_IsDeletedFalseAndPerson_Address_GramPanchayat_Mandal_District_State_StateName(String state);
}
